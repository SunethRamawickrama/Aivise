  ...
  return (
    <>
      <button 
        ...
        disabled={isLoading}
        className={`flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition transform duration-200 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
      >
